...
public class YouTubeManager extends SimpleViewManager<YouTubeView> {
    ...
    private static final int COMMAND_REFRESH_CONTROLS = 5;
    ...
    // Added an new endpoint to set controls display in order to force them to show
    @Override
    ...
    public void receiveCommand(YouTubeView view, int commandType, @Nullable ReadableArray args) {
        ...
        switch (commandType) {
            ...
            case COMMAND_REFRESH_CONTROLS:{
                view.setControls(args.getInt(0));
                return;
            }
            default:

...
public class YouTubePlayerController implements
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean wasRestored) {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on init success", e);
        }
    }
    ...
    public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult result) {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error init fail", e);
        }
    }
    ...
    public void onPlaying() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on playing", e);
        }
    }
    ...
    public void onPaused() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on paused", e);
        }
    }
    ...
    public void onStopped() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on stopped", e);
        }
    }
    ...
    public void onBuffering(boolean buffering) {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on buffering", e);
        }
    }
    ...
    public void onSeekTo(int i) {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on seek to", e);
        }
    }
    ...
    public void onLoading() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on loading", e);
        }
    }
    ...
    public void onLoaded(String videoId) {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on loaded", e);
        }
    }
    ...
    public void onAdStarted() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on ad started", e);
        }
    }
    ...
    public void onVideoStarted() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on video started", e);
        }
    }
    ...
    public void onVideoEnded() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on video ended", e);
        }
    }
    ...
    public void onFullscreen(boolean isFullscreen) {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on full screen", e);
        }
    }
    ...
    public void onError(YouTubePlayer.ErrorReason errorReason) {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on error", e);
        }
    }
    ...
    public void seekTo(int second) {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error seek to", e);
        }
    }
    ...
    public int getCurrentTime() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error get current time", e);
        }
        return 0;
    }
    public int getDuration() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error get duration time", e);
        }
        return 0;
    }
    ...
    public void nextVideo() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on next video", e);
        }
    }
    ...
    public void previousVideo() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error get on previous video", e);
        }
    }
    ...
    public void playVideoAt(int index) {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on play video at", e);
        }
    }
    ...
    private void loadVideo() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error get on load video", e);
        }
    }
    ...
    private void loadVideos() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on load videos", e);
        }
    }
    ...
    private void loadPlaylist() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on load playlist", e);
        }
    }
    ...
    private void updateControls() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on update controls", e);
        }
    }
    ...
    private void updateFullscreen() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on update full screen", e);
        }
    }
    ...
    private void updateShowFullscreenButton() {
        try {
            ...
            Log.e("ZZZZ", "Youtube Error on show full screen", e);
        }
    }
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        // android crush report zzzz    
                        //   java.lang.IllegalStateException: 
                        //   at mej.a (SourceFile:91)
                        //   at mej.l (SourceFile:181)
                        //   at aors.dispatchTransaction (SourceFile:123)
                        //   at cpl.onTransact (SourceFile:7)
